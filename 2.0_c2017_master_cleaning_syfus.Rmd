...
d.all.f %<>% mutate(disadv_num = atrisk_nointlwPI_regFG_USETHIS,
                    ...
                    race_old = factor(race, levels = c(1, 2, 3, 4, 5, 7), 
                                  labels = c("asian", "black", "latino", "native", "white", "pislander")),
                    race = ifelse(race_old == "native" | race_old == "pislander", 4, race_old) %>% 
...
d.all.f %>% count(race_nointl_wPI_USETHIS, race_old, race, race_asian, race_black, race_latino, race_native, race_white, race_pi)
```
